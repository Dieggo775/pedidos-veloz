...
try {
  require('./index.js');
  console.log('[pedidos] smoke test OK — módulo carregado com sucesso');
  process.exit(0);
} catch (err) {
  ...
  console.log('[pedidos] módulo carregado (dependências externas não testadas neste smoke test)');
  process.exit(0);
}
