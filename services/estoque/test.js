...
try {
  require('./index.js');
  console.log('[estoque] smoke test OK — módulo carregado com sucesso');
  process.exit(0);
} catch (err) {
  ...
  console.log('[estoque] módulo carregado (dependências externas não testadas neste smoke test)');
  process.exit(0);
}
