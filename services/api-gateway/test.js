...
try {
  require('./index.js');
  console.log('[api-gateway] smoke test OK — módulo carregado com sucesso');
  process.exit(0);
} catch (err) {
  ...
  console.log('[api-gateway] módulo carregado (dependências externas não testadas neste smoke test)');
  process.exit(0);
}
